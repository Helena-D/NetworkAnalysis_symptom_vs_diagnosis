...
# Select relevant variables (for variables that can change) hal here
```{r}
 ...
 filter(
        (
          ...
          is.na(ed.DSM5_BN_binary_numeric)) &
            (an.1.anorexia_nervosa_binge_purge == "Not Anorexia binge-eating/purging" |
          is.na(an.1.anorexia_nervosa_binge_purge)) &
 ...
 filter(
        (((ed.DSM5_BED_binary_numeric == 1 |
         ...
         ((ed.DSM5_AN_binge_purge_binary_numeric == 0 |
          is.na(ed.DSM5_AN_binge_purge_binary_numeric)) &
            (an.1.anorexia_nervosa_binge_purge == "Not Anorexia binge-eating/purging" |
          is.na(an.1.anorexia_nervosa_binge_purge)))) & # Does not have ANBP in GLAD or EDGI UK (sign-up)
...
dat_diag_cross_check_ANBP <- dat_diag_cross_check %>%
  filter(ed.DSM5_AN_binge_purge_binary_numeric_cop == 1 |
           ed.DSM5_AN_binge_purge_binary_numeric == 1 |
           an.1.anorexia_nervosa_binge_purge == "Anorexia binge-eating/purging") # 82 people with ANBP
