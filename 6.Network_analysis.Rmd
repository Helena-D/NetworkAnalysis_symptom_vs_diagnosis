...
```{r Read in data}
# Diagnosis dat
diagnosis_dat <- readRDS(file = "../../data/diagnosis_dat_analysis2023-04-06.rds")
dim(diagnosis_dat)
...
# Change sample name of those recruited from GLAD into NBR
Three people have been recruited from GLAD into NBR.
1c97262b3a6606ae69c33a8326e4
b008f8d642939db88b0c274e299f
b4995225c8db04d9073438da3345
```{r changing sample name from NBR to GLAD}
# Symptom data
symptom_dat %>%
  filter(ID == "1c97262b3a6606ae69c33a8326e4") # In dataset

symptom_dat %>%
  filter(ID == "b008f8d642939db88b0c274e299f") # In dataset

symptom_dat %>% 
  filter(ID == "b4995225c8db04d9073438da3345") # In dataset
...
symptom_dat <- symptom_dat %>%
  mutate(sample =
           case_when(ID == "1c97262b3a6606ae69c33a8326e4" |
                     ID == "b008f8d642939db88b0c274e299f" |
                     ID == "b4995225c8db04d9073438da3345" ~ "GLAD",
...
# Diagnosis data
diagnosis_dat %>%
  filter(ID == "1c97262b3a6606ae69c33a8326e4") # Not in dataset

diagnosis_dat %>%
  filter(ID == "b008f8d642939db88b0c274e299f") # Not in dataset

diagnosis_dat %>%
  filter(ID == "b4995225c8db04d9073438da3345") # Not in dataset
...
Pre-processing checks assessing collinearity need to be conducted using the ‘goldbricker’ function from the R package ‘networktools’, which compares correlations in order to identify nodes which are likely to measure the same underlying construct.
...
# CC = accuracy/correct classifcation, nCC = normalised accuracy, CCmarg = accuracy of intercept model
...
ANBPcommunities$`7` <- c(14,
                        15)

ANBPcommunities$`8`  <- NULL
...
ANBPcommunities$`Cluster 4` <- ANBPcommunities$`4` 
ANBPcommunities$`4`  <- NULL

ANBPcommunities$`Cluster 5` <- ANBPcommunities$`5` 
ANBPcommunities$`5`  <- NULL

ANBPcommunities$`Cluster 6` <- ANBPcommunities$`6` 
ANBPcommunities$`6`  <- NULL

ANBPcommunities$`Covariates` <-ANBPcommunities$`7` 
ANBPcommunities$`7`  <- NULL
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_plot_ANBP_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/edge_accuracy_plot_ANBP_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_stability_plot_ANBP_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_edges_plot_ANBP_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_node_centralities_plot_ANBP_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_plot_BN_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/edge_accuracy_plot_BN_", date, ".png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_stability_plot_BN_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_edges_plot_BN_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_node_centralities_plot_BN_", date, ".png")) 
...
# Rename clusters (named to match BN)
BEDcommunities$`Cluster 1` <- BEDcommunities$`2` 
BEDcommunities$`2`  <- NULL

BEDcommunities$`Cluster 2` <- BEDcommunities$`1` 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_plot_BED_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/edge_accuracy_plot_BED_", date, ".png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/centrality_stability_plot_BED_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_edges_plot_BED_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/checks/sig_diff_node_centralities_plot_BED_", date, ".png")) 
...
```{r}
load("/Users/helenadavies/werk/NetAnalEDMan/BED_env1.RData")
load("/Users/helenadavies/werk/NetAnalEDMan/BN_env1.RData")
```

### Average layout
Calculate average layout of all 3 networks to then constrain them all to that layout (don't use Fruchterman-Reingold)
...
ANBP_network_plot <- qgraph::qgraph(ANBP_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in ANBP sample,
                   n = 825",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/network_plots/network_ANBP_average_layout"),
       width = 10,
       height = 10
      )
...
BN_network_plot <- qgraph::qgraph(BN_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BN sample,
                   n = 3737",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/network_plots/network_BN_average_layout"),
       width = 10,
       height = 10
      )
...
BED_network_plot <- qgraph::qgraph(BED_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BED sample,
                   n = 3648",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/network_plots/network_BED_average_layout"),
       width = 10,
       height = 10
      )
```
...
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/centrality_plot_BE_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/edge_accuracy_plot_BE_", date, ".png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/centrality_stability_plot_BE_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/sig_diff_edges_plot_BE_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/sig_diff_node_centralities_plot_BE_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/centrality_plot_no_BE_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/edge_accuracy_plot_no_BE_", date, ".png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/centrality_stability_plot_no_BE_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/sig_diff_edges_plot_no_BE_", date, ".png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/symptom/network_plots/checks/sig_diff_centrality_plot_no_BE_", date, ".png")) 
...
BE_network_plot <- qgraph::qgraph(BE_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BE sample,
                   n = 12,104",
       filetype = "png",
       filename = paste0(filepath_plots, "/symptom/network_plots/network_BE_average_layout"),
       width = 10,
       height = 10
      )
...
no_BE_network_plot <- qgraph::qgraph(no_BE_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in no BE sample,
                   n = 22,122",
       filetype = "png",
       filename = paste0(filepath_plots, "/symptom/network_plots/network_no_BE_average_layout"),
       width = 10,
       height = 10
      )
```
...
corr_no_age_sex # 0.77
corr_no_age_sex$p.value # 6.82x10-32
```
...
sum(abs(na.omit(BN_network_no_age_sex))) # 15.79
sum(abs(na.omit(ANBP_network_no_age_sex))) # 14.95
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/centrality_diff_ANBP_vs_BN_", date, ".png"))
...
~runs 1000 networks with the same sample sizes as your original two, but randomly assigning people to each one.  Creates a distribution of the null hypothesis - this shows what our networks would look like assuming that ED does not matter. We then compare our actual network to this network. Then sees if the differences you found are bigger than random differences you get when you just split the sample into those size groups

~the 1000 permutations are run, and the value of difference between the networks in each of the permutations is put into a distribution. That's the distribution that is then used to assess whether your original difference was big enough to be significant, if a larger difference is found only in less that 5% of permutations you conclude that the difference you found was just to your group allocation, not just to chance
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/global_strength_plot_ANBP_vs_BN_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/network_structure_plot_ANBP_vs_BN_", date, ".png")) 
...
edge_accuracy_BN_network$sampleTable # 0.73
edge_accuracy_ANBP_network$sampleTable # 0.07543772
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/centrality_diff_ANBP_vs_BED_", date, ".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/global_strength_plot_ANBP_vs_BED_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/network_structure_plot_ANBP_vs_BED_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/centrality_diff_BN_vs_BED_", date, ".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/global_strength_plot_BN_vs_BED_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/network_structure_plot_BN_vs_BED_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/network_plots/comparisons/centrality_diff_ANBP_BN_BED_", date, ".png"))
...
png(file = paste0(filepath_plots, "/symptom/network_plots/comparisons/centrality_diff_BE_vs_no_BE_", date, ".png"))
...
png(file = paste0(filepath_plots, "/symptom/network_plots/comparisons/global_strength_plot_BE_vs_no_BE_", date, ".png")) 
...
png(file = paste0(filepath_plots, "/symptom/network_plots/comparisons/network_structure_plot_BE_vs_no_BE_", date, ".png")) 
...
networkcomparison_BE_no_BE$einv.pvals # The Bonferroni corrected p values per edge from the permutation test concerning differences in edges weight
...
plot(networkcomparison_BE_no_BE, # The distribution(s) of the edge strength invariance test can be plotted
    what="edge")

edge_accuracy_no_BE_network$sampleTable # 0.41 1.54 0.70
edge_accuracy_BE_network$sampleTable  # 0.23 1.29 0.55
```
