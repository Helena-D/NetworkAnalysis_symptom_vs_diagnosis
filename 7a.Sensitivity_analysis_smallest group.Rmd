---
title: 'Sensitivity analysis: Smallest group size (n = 825)'
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_centrality_plot_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_edge_accuracy_plot_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_centrality_stability_plot_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_sig_diff_edges_plot_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_sig_diff_centrality_plot_BE.png"))
...
# Rename clusters
no_BEcommunities$`Covariates` <- no_BEcommunities$`1` 
no_BEcommunities$`1`  <- NULL

no_BEcommunities$`Cluster 1` <- no_BEcommunities$`2` 
no_BEcommunities$`2`  <- NULL

no_BEcommunities$`Cluster 2` <- no_BEcommunities$`3` 
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_centrality_plot_no_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_edge_accuracy_plot_no_BE.png"))
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_centrality_stability_plot_no_BE.png"))
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_sig_diff_edges_plot_no_BE.png"))
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_sig_diff_centrality_plot_no_BE.png"))
...
BE_network_plot <- qgraph::qgraph(BE_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BE sample,
                   n = 825",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_network_BE_average_layout"),
       width = 10,
       height = 10
      )
...
no_BE_network_plot <- qgraph::qgraph(no_BE_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       groups =  no_BEcommunities,
       palette = "colorblind",
       color = c("grey", # covariates in grey
                  "orange",
                 "light blue"
       ...
       title = "Network of mania symptoms in no BE sample,
                   n = 825",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_network_no_BE_average_layout"),
       width = 10,
       height = 10
      )
```
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/centrality_diff_BE_vs_no_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_global_strength_plot_BE_vs_no_BE.png"))
...
png(file = paste0(filepath_plots, "/revised_symptom/sensitivity_analysis/1a.Smallest_group/sens_network_structure_plot_BE_vs_no_BE.png"))
...
edge_accuracy_no_BE_network$sampleTable # 0.53483441	# 0.50712811	# 1.74399732 # 0.58691867	
