...
# Symptom dat
symptom_dat <- readRDS(file = "../../data/symptom_dat_analysis2023-04-11.rds")
dim(symptom_dat)
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_plot_ANBP.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/edge_accuracy_plot_ANBP.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_stability_plot_ANBP.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_edges_plot_ANBP.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_node_centralities_plot_ANBP.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_plot_BN.png"))
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_stability_plot_BN.png"))
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_edges_plot_BN.png"))
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_node_centralities_plot_BN.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_plot_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/edge_accuracy_plot_BED.png"))
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_stability_plot_BED.png"))
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_edges_plot_BED.png"))
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/sig_diff_node_centralities_plot_BED.png"))
...
ANBP_network_plot <- qgraph::qgraph(ANBP_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in ANBP sample,
                   n = 751",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_ANBP_average_layout"),
       width = 10,
       height = 10
      )
...
BN_network_plot <- qgraph::qgraph(BN_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BN sample,
                   n = 3576",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_BN_average_layout"),
       width = 10,
       height = 10
      )
...
BED_network_plot <- qgraph::qgraph(BED_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BED sample,
                   n = 3488",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_BED_average_layout"),
       width = 10,
       height = 10
      )
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_diff_ANBP_vs_BN.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/global_strength_plot_ANBP_vs_BN.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_structure_plot_ANBP_vs_BN.png"))
...
edge_accuracy_BN_network$sampleTable  # 0.731760855
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_diff_ANBP_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/global_strength_plot_ANBP_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_structure_plot_ANBP_vs_BED.png"))
...
edge_accuracy_ANBP_network$sampleTable  # 0.00000000
edge_accuracy_BED_network$sampleTable # 0.492840984
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_diff_BN_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/global_strength_plot_BN_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/network_structure_plot_BN_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/4.Atleast_one_mania_symptom/centrality_diff_ANBP_BN_BED_sens_atleast_one_mania_symptom.png"))
