...
load(paste0(filepath_own, "NetAnalEDMan/All_NetA_main.RData"))
```
...
# Rename clusters
ANBPcommunities$`Cluster 1` <- ANBPcommunities$`2` 
ANBPcommunities$`2`  <- NULL

ANBPcommunities$`Cluster 2` <- ANBPcommunities$`1` 
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_plot_ANBP_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_edge_accuracy_plot_ANBP_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_stability_plot_ANBP_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_edges_plot_ANBP_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_node_centralities_plot_ANBP_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_plot_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_edge_accuracy_plot_BN_",date,".png"))
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_stability_plot_BN_",date,".png"))
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_edges_plot_BN_",date,".png"))
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_node_centralities_plot_BN_",date,".png"))
...
# Manually move age and sex into their own community (they are covariates. We estimated the groups first because we need the associations that have been adjusted for age and sex, but do not want them to form part of a group because they are not symptoms)
mixed_presentationcommunities$`2`  <- c(2,
                                        6,
                                        7,
                                        12,
                                        13
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_plot_mixed_presentation_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_edge_accuracy_plot_mixed_presentation_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_stability_plot_mixed_presentation_",date,".png"))
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_edges_plot_mixed_presentation_",date,".png"))
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_sig_diff_node_centralities_plot_mixed_presentation_",date,".png"))
...
ANBP_network_plot <- qgraph::qgraph(sens_ANBP_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Sensitivity analysis ('pure' groups): Network of mania symptoms in ANBP sample,
                   n = 445",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/network_ANBP_average_layout"),
       width = 10,
       height = 10
      )
...
BN_network_plot <- qgraph::qgraph(sens_BN_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Sensitivity analysis ('pure' groups): Network of mania symptoms in BN sample,
                   n = 1951",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/network_BN_average_layout"),
       width = 10,
       height = 10
      )
...
BED_network_plot <- qgraph::qgraph(BED_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Sensitivity analysis ('pure' groups): Network of mania symptoms in BED sample,
                   n = 3648",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/network_BED_average_layout"),
       width = 10,
       height = 10
      )
...
mixed_presentation_network_plot <- qgraph::qgraph(mixed_presentation_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Sensitivity analysis ('pure' groups): Network of mania symptoms in mixed presentation sample,
                   n = 2166",
       filetype = "png",
       filename = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/network_mixed_presentation_average_layout"),
       width = 10,
       height = 10
      )
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_ANBP_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_ANBP_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_ANBP_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_ANBP_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_ANBP_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_ANBP_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_BN_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_BN_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_BN_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_ANBP_vs_mixed_presentation_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_ANBP_vs_mixed_presentation_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_ANBP_vs_mixed_presentation_",date,".png"))
...
edge_accuracy_ANBP_network$sampleTable # 0.00000000
edge_accuracy_mixed_presentation_network$sampleTable # 0.68244330	
```
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_mixed_presentation_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_mixed_presentation_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_mixed_presentation_vs_BED_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_centrality_diff_mixed_presentation_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_global_strength_plot_mixed_presentation_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/sens_network_structure_plot_mixed_presentation_vs_BN_",date,".png"))
...
png(file = paste0(filepath_plots, "/revised_diagnosis/sensitivity_analysis/2.Pure_ED_cases/centrality_diff_ANBP_BN_BED_sens_pure_ED_groups_",date,".png"))
