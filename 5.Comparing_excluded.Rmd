...
excluded_dat <- readRDS(file = paste0("../data/excluded_dat_analysis2022-04-04.rds"))
dim(excluded_dat) 
...
sex <- table(descriptives_dummy$excluded,
             descriptives_dummy$sex_final_Female
...
edu <- table(descriptives_dummy$excluded,
...
race <- table(descriptives_dummy$excluded,
