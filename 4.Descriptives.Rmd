...
# Symptom dat
symptom_dat <- readRDS(file = "../../data/symptom_dat_analysis2023-04-05.rds")
dim(symptom_dat)
...
symptom_dat_long <- symptom_dat_long %>%
  mutate(binge_eating_with_loss_control_renamed =
           case_when(binge_eating_with_loss_control == "No BE" ~ "No binge eating",
                     binge_eating_with_loss_control == "BE" ~ "Binge eating"))
```
...
symptom_dat_long %>% 
  ...
  ggplot(
    aes(
      y = binge_eating_with_loss_control_renamed,
      fill = Endorsement, 
      )
    ) +
  geom_bar(
...
diagnosis_dat <- diagnosis_dat %>%
  select(
    ...
    sex_numeric = sex_final_numeric,
    ethnicity,
    bulimia_nervosa_self_report,
    bulimia_nervosa_algorithm_derived,
    binge_eating_disorder_self_report,
    binge_eating_disorder_algorithm_derived,
    anorexia_nervosa_binge_purge_algorithm_derived,
...
```{r check freq of self-report vs algorithm-derived BN}
# Both
diagnosis_dat %>%
  filter(bulimia_nervosa_self_report == 1 &
           bulimia_nervosa_algorithm_derived == 1) %>%
  nrow()

# ALgorithm-only
diagnosis_dat %>%
  filter((bulimia_nervosa_self_report == 0 |
           is.na(bulimia_nervosa_self_report)) &
           bulimia_nervosa_algorithm_derived == 1) %>%
  nrow()

# Self-report-only
diagnosis_dat %>%
  filter((bulimia_nervosa_algorithm_derived == 0 |
           is.na(bulimia_nervosa_algorithm_derived)) &
           bulimia_nervosa_self_report == 1) %>%
  nrow()
```
```{r check freq of self-report vs algorithm-derived Bed}
# Both
diagnosis_dat %>%
  filter(binge_eating_disorder_self_report == 1 &
           binge_eating_disorder_algorithm_derived == 1) %>%
  nrow()

# ALgorithm-only
diagnosis_dat %>%
  filter((binge_eating_disorder_self_report == 0 |
           is.na(binge_eating_disorder_self_report)) &
           binge_eating_disorder_algorithm_derived == 1) %>%
  nrow()

# Self-report-only
diagnosis_dat %>%
  filter((binge_eating_disorder_algorithm_derived == 0 |
           is.na(binge_eating_disorder_algorithm_derived)) &
           binge_eating_disorder_self_report == 1) %>%
  nrow()
```
...
png(width = 800,
    height = 800,
    file = paste0(filepath_plots, "/diagnosis/descriptives/mania_symptom_endorsement_diag", date, ".png"
    ))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/all_age_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/ANBP_age_histogram_diag_", date, ".png"))
...
# Histogram of age- ANBP
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BN_age_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BED_age_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/formatted_age_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/all_bmi_signup_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/ANBP_bmi_signup_histogram_diag_", date, ".png"))
...
# Histogram of BMI signup- ANBP
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BN_bmi_signup_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BED_bmi_signup_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/formatted_bmi_signup_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/all_bmi_lowest_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/ANBP_bmi_lowest_histogram_diag_", date, ".png"))
...
# Histogram of BMI lowest- ANBP
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BN_bmi_lowest_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BED_bmi_lowest_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/formatted_bmi_lowest_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/all_bmi_highest_qqplot_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/ANBP_bmi_highest_histogram_diag_", date, ".png"))
...
# Histogram of BMI highest- ANBP
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BN_bmi_highest_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/BED_bmi_highest_histogram_diag_", date, ".png"))
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/formatted_bmi_highest_qqplot_diag_", date, ".png"))
