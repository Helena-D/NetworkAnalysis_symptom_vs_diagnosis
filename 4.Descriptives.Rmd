...
symptom_dat <- symptom_dat %>%
  mutate(binge_eating_with_loss_control =
    case_when(binge_eating_with_loss_control == "BE loss control" ~ "BE loss control",
...
png(file = paste0(filepath_plots, "/symptom/descriptives/symptom/descriptives/mania_symptom_endorsement_symp.png",
    width = 800,
    height = 800
    ))
...
symptom_dat_long %>% 
  ...
  theme(
    ...
    strip.text = element_text(size = 13) # size of text in each facet
) +
...
png(file = paste0(filepath_plots, "/diagnosis/descriptives/mania_symptom_endorsement_diag.png",
    width = 800,
    height = 800))
