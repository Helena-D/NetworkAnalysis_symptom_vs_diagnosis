---
title: 'Sensitivity analysis: Network analysis AN-B only'
...
```{r Read in data}
# Diagnosis dat
diagnosis_dat <- readRDS(file = "../data/diagnosis_dat_analysis2022-02-11.rds")
dim(diagnosis_dat)
...
mania_nodes_ANB <- diagnosis_dat %>%
   filter(ED_hierarchical_sens_ANB == "Anorexia binge eating only") %>%
  select(
...
ANBcommunities$`4` <- c(14,
                        15)

ANBcommunities$`5`  <- NULL
...
ANBcommunities$`Cluster 3` <- ANBcommunities$`3` 
ANBcommunities$`3`  <- NULL

ANBcommunities$`Covariates` <-ANBcommunities$`4` 
ANBcommunities$`4`  <- NULL
```
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_plot_ANB.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/edge_accuracy_plot_ANB.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_stability_plot_ANB.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_edges_plot_ANB.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_node_centralities_plot_ANB.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_plot_BN.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/edge_accuracy_plot_BN.png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_stability_plot_BN.png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_edges_plot_BN.png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_node_centralities_plot_BN.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_plot_BED.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/edge_accuracy_plot_BED.png")) 
...
# Plot centrality stability
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_stability_plot_BED.png")) 
...
# Plot significant differences (alpha = 0.05) of edge weights:
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_edges_plot_BED.png")) 
...
# Plot significant differences (alpha = 0.05) of node centrality eg. strength for all nodes:
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/sig_diff_node_centralities_plot_BED.png")) 
...
ANB_network_plot <- qgraph::qgraph(ANB_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in ANB sample,
                   n = 383",
       filetype = "png",
       filename = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_ANB_average_layout"),
       width = 10,
       height = 10
      )
...
BN_network_plot <- qgraph::qgraph(BN_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BN sample,
                   n = 7904",
       filetype = "png",
       filename = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_BN_average_layout"),
       width = 10,
       height = 10
      )
...
BED_network_plot <- qgraph::qgraph(BED_network$pairwise$wadj, # weighted adjacency matrix as input
       ...
       title = "Network of mania symptoms in BED sample,
                   n = 1393",
       filetype = "png",
       filename = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_BED_average_layout"),
       width = 10,
       height = 10
      )
```
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_diff_ANB_vs_BN.png"))
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/global_strength_plot_ANB_vs_BN.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_structure_plot_ANB_vs_BN.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_diff_ANB_vs_BED.png"))
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/global_strength_plot_ANB_vs_BED.png")) 
...
networkcomparison_ANB_BED$nwinv.pval # significance of difference in structure/organisation

test_networkcomparison_ANB_BED$nwinv.real # max difference in network structure
test_networkcomparison_ANB_BED$nwinv.pval # significance of difference in structure/organisation

png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_structure_plot_ANB_vs_BED.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_diff_BN_vs_BED.png"))
...
### 5. Global strength: BN versus BN differences 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/global_strength_plot_BN_vs_BED.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/network_structure_plot_BN_vs_BED.png")) 
...
png(file = paste0(filepath_plots, "/diagnosis/sensitivity_analysis/3.ANB_only/centrality_diff_sens_ANB_BN_BED.png"))
